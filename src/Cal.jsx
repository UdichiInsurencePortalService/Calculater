...
const Cal = () => {
  ...
  // Lab grown Diamond
  const [LabgrownDiamondData, setLaggrownDiamondData] = useState({
    central: { marketPrice: '', quantity: '', total: 0 },
    side: { marketPrice: '', quantity: '', total: 0 },
    category: '',
    grandTotal: 0
  ...
  const calculateNaturalDiamond = () => {
   ...
   const calculateLabgrownDiamond = () => {
    const centralTotal = (parseFloat(LabgrownDiamondData.central.marketPrice) || 0) * (parseFloat(LabgrownDiamondData.central.quantity) || 0);
    const sideTotal = (parseFloat(LabgrownDiamondData.side.marketPrice) || 0) * (parseFloat(LabgrownDiamondData.side.quantity) || 0);
    const grandTotal = centralTotal + sideTotal;

    setLaggrownDiamondData(prev => ({
      ...prev,
      central: { ...prev.central, total: centralTotal },
      side: { ...prev.side, total: sideTotal },
      grandTotal
  ...
  const generatePDF = (category, data) => {
    ...
    switch(category) {
      ...
      case 'Natural Diamond':
        ...
        `;
        break;
      case 'Labgrown Diamond':
        content += `
          <table class="calculation-table">
            <tr><th>Diamond Type</th><th>Price per Carat</th><th>Quantity (Carats)</th><th>Total Value</th></tr>
            <tr>
              <td>Central Stone</td>
              <td>₹${LabgrownDiamondData.central.marketPrice || '0'}</td>
              <td>${LabgrownDiamondData.central.quantity || '0'}</td>
              <td>${formatCurrency(LabgrownDiamondData.central.total)}</td>
            </tr>
            <tr>
              <td>Side Stone</td>
              <td>₹${LabgrownDiamondData.side.marketPrice || '0'}</td>
              <td>${LabgrownDiamondData.side.quantity || '0'}</td>
              <td>${formatCurrency(LabgrownDiamondData.side.total)}</td>
            </tr>
          </table>
          <div class="total-section">
            <h3 style="margin-top: 0;">Total Natural Diamond Value: ${formatCurrency(LabgrownDiamondData.grandTotal)}</h3>
            <p><strong>Central Stone:</strong> ${LabgrownDiamondData.central.marketPrice || '0'} × ${LabgrownDiamondData.central.quantity || '0'} = ${formatCurrency(LabgrownDiamondData.central.total)}</p>
            <p style="margin-bottom: 0;"><strong>Side Stone:</strong> ${LabgrownDiamondData.side.marketPrice || '0'} × ${LabgrownDiamondData.side.quantity || '0'} = ${formatCurrency(LabgrownDiamondData.side.total)}</p>
          </div>
        `;
        break;
      case 'Color Stone':
  ...
  const metals = [
    ...
    {
      key: 'LabgrownDiamond',
      name: 'Labgrown Diamond',
      icon: Gem,
      color: '#1fb491ff',
      bgGradient: 'linear-gradient(135deg, #249d40ff 0%, #357ABD 100%)'
    },
    {
      key: 'colorStone',
      name: 'Color Stone',
  ...
  const renderNaturalDiamondCalculator = () => (
    ...
    const renderLabgrownDiamondCalculator = () => (
    <div className="min-vh-100 py-5" style={{ background: 'linear-gradient(135deg, #4A90E2 0%, #357ABD 100%)' }}>
      <div className="container">
        <div className="row justify-content-center">
          <div className="col-lg-10">
            <div className="card shadow-lg border-0" style={{ background: 'rgba(255,255,255,0.95)', backdropFilter: 'blur(10px)' }}>
                ...
                <div className="d-flex align-items-center justify-content-between">
                  <div className="d-flex align-items-center">
                    ...
                    <div className="d-flex align-items-center">
                      <Gem size={32} className="text-primary me-3" />
                      <div>
                        <h2 className="mb-0 fw-bold">Labgrown Diamond Calculator</h2>
                        <p className="mb-0 text-muted">Calculate your Labgrown diamond portfolio value</p>
                      </div>
                    </div>
                  </div>
                  <button 
                    className="btn btn-success"
                    onClick={() => generatePDF('Labgrown Diamond', LabgrownDiamondData)}
                    disabled={LabgrownDiamondData.grandTotal === 0}
                  >
                    <Download size={16} className="me-2" />
                    Download PDF
                  </button>
              ...
              <div className="card-body p-4">
                ...
                <div className="row mb-4">
                  <div className="col-md-6 mx-auto">
                    ...
                    <input
                      type="text"
                      className="form-control form-control-lg"
                      value={LabgrownDiamondData.category}
                      onChange={(e) => setLaggrownDiamondData(prev => ({ ...prev, category: e.target.value }))}
                      placeholder="e.g., Engagement Ring, Pendant, Earrings, etc."
                    />
                    <small className="text-muted">Optional: Specify product type</small>
                  </div>
                      ...
                      <div className="card-body">
                        <div className="mb-3">
                          ...
                          <input
                            type="number"
                            className="form-control"
                            value={LabgrownDiamondData.central.marketPrice}
                            onChange={(e) => setLaggrownDiamondData(prev => ({
                              ...prev,
                              central: { ...prev.central, marketPrice: e.target.value }
                            }))}
                            placeholder="Enter price"
                        ...
                        <div className="mb-3">
                          ...
                          <input
                            type="number"
                            className="form-control"
                            value={LabgrownDiamondData.central.quantity}
                            onChange={(e) => setLaggrownDiamondData(prev => ({
                              ...prev,
                              central: { ...prev.central, quantity: e.target.value }
                            }))}
                        ...
                        {LabgrownDiamondData.central.total > 0 && (
                          <div className="text-center">
                            <strong className="text-primary">
                              {formatCurrency(LabgrownDiamondData.central.total)}
                            </strong>
                          </div>
                        )}
                      </div>
                      ...
                      <div className="card-body">
                        <div className="mb-3">
                          ...
                          <input
                            type="number"
                            className="form-control"
                            value={LabgrownDiamondData.side.marketPrice}
                            onChange={(e) => setLaggrownDiamondData(prev => ({
                              ...prev,
                              side: { ...prev.side, marketPrice: e.target.value }
                            }))}
                        ...
                        <div className="mb-3">
                          ...
                          <input
                            type="number"
                            className="form-control"
                            value={LabgrownDiamondData.side.quantity}
                            onChange={(e) => setLaggrownDiamondData(prev => ({
                              ...prev,
                              side: { ...prev.side, quantity: e.target.value }
                            }))}
                        ...
                        {LabgrownDiamondData.side.total > 0 && (
                          <div className="text-center">
                            <strong className="text-info">
                              {formatCurrency(LabgrownDiamondData.side.total)}
                            </strong>
                          </div>
                        )}
                      </div>
                ...
                <div className="text-center mt-4">
                  <button 
                    className="btn btn-primary btn-lg px-5 fw-semibold"
                    onClick={calculateLabgrownDiamond}
                  >
                    Calculate Natural Diamond Value
                  </button>
                </div>
 ...
 return (
    <>
      ...
      {activeCalculator === 'LabgrownDiamond' && renderLabgrownDiamondCalculator()}
